...
export default function AftercareListClient({ initialProducts, initialPage }) {
  const [page, setPage] = useState(initialPage);
  const [aftercare, setAftercare] = useState(initialProducts);
  ...
  return (
    <div className='bg-brand-light'>
      <SectionHero title='Aftercare' subtitle='Keep your pieces looking their best' />
